...
<body>
            ...
            <div class="dropdown" style="margin-top: 5px;">
                ...
                <ul class="dropdown-menu text-small">
                    <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i
                                class='bx bxs-file-plus' style='color:#5395e7'></i> <span>Agendar
                                evento</span></a></li>
                    <li><a class="dropdown-item" href="#"><i class='bx bxs-user-rectangle' style='color:#718ae9'></i>
                            <span>Mi perfil</span></a></li>
                    <li><a class="dropdown-item" href="./logout-action.php"> <i class='bx bxs-log-in'
                                style='color:#ff0000'></i> <span> <b>Cerrar sesion</b></span></a></li>
                    <li>
                        <hr class="dropdown-divider">
                    </li>

                    <li><a class="dropdown-item" href="../assets/documents/Políticas de Privacidad EventTotal.pdf"
                            target="_blank">
                            <span class="opciones-documentacion">Politica de Privacidad</span></a></li>

                    <li><a class="dropdown-item" href="../assets/documents/Condiciones de Servicio EventTotal.pdf"
                            target="_blank">
    ...
    <div class="wrapper" id="contenedor-main">
        <h1>Titulo de apartado</h1>
        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eveniet temporibus nihil amet unde delectus molestias cum officiis assumenda suscipit iste, minus a quod possimus ea odit doloribus dolorum recusandae dolore.</p>
    </div>

    ...
    <div class="wrapper" id="contenedor-main">
        ...
        <center>
            <div class="resume-activity">
                <div class="target" id="target-eventos"><i class='bx bxs-calendar-alt' style='color:#ffffff'><span> Eventos: 0</span></i></div>
                <div class="target" id="target-salones"><i class='bx bx-building-house' style='color:#ffffff'><span> Salones: 0</span></i></div>
                <div class="target" id="target-empleados"><i class='bx bx-user' style='color:#ffffff'><span> Empleados: 0</span></i></div>
                <div class="target" id="target-recetas"><i class='bx bx-book' style='color:#ffffff'><span> Recetas: 0</span></i></div>
            </div>
        </center>
                    ...
                    <div class="col-sm-6 mb-3 mb-sm-0" style="margin-top: 20px;">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="#" class="btn" style="background-color: #718ae9; color: white;">Mas informacion</a>
                            </div>
                        </div>
                    </div>

                    <div class="col col-sm-6 mb-3 mb-sm-0" style="margin-top: 20px;">
                        <div class="card">
                            <div class="card-header">
                                Featured
                            </div>
